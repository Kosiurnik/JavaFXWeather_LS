...
public class Current {
    ...
    @JsonProperty("temp_c")
    public long getTempC() { return tempC; }
    @JsonProperty("temp_c")
    public void setTempC(long value) { this.tempC = value; }
    ...
    public long getWindMph() { return windMph; }
    @JsonProperty("wind_mph")
    public void setWindMph(long value) { this.windMph = value; }
